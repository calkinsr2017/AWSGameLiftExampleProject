...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnDescribeGameSessionsStateSuccess, const FString&, SessionId);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnDescribeGameSessionsStateFailed, const FString&, ErrorMessage);
UCLASS()
class GAMELIFTCLIENTSDK_API UGameLiftDescribeGameSessions : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintAssignable, Category = "GameLift DescribeGameSessions")
		FOnDescribeGameSessionsStateSuccess OnDescribeGameSessionsStateSuccess;
	
	UPROPERTY(BlueprintAssignable, Category = "GameLift DescribeGameSessions")
		FOnDescribeGameSessionsStateFailed OnDescribeGameSessionsStateFailed;

private:
	Aws::GameLift::GameLiftClient* GameLiftClient;

	static UGameLiftDescribeGameSessions* DescribeGameSessions();

public:
	UFUNCTION(BlueprintCallable, Category = "GameLift DescribeGameSessions")
		EActivateStatus Activate();

private:
	void OnDescribeGameSessionsState(const Aws::GameLift::GameLiftClient* Client, const Aws::GameLift::Model::DescribeGameSessionsRequest& Request, const Aws::GameLift::Model::DescribeGameSessionsOutcome& Outcome, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& Context);
