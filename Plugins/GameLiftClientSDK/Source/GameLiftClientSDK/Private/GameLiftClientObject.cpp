...
UGameLiftDescribeGameSessions* UGameLiftClientObject::DescribeGameSessions()
{
#if WITH_GAMELIFTCLIENTSDK
	UGameLiftDescribeGameSessions* Proxy = UGameLiftDescribeGameSessions::DescribeGameSessions();
	Proxy->GameLiftClient = GameLiftClient;
	return Proxy;
#endif
	return nullptr;
